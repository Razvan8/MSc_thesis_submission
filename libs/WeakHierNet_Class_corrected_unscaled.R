...
WeakHierNetUnscaled <- function(X, Beta_plus_init, Beta_minus_init, Theta_init, y, lambda, t=1, tol=1e-2, max_iter=5000, eps=1e-8, Z=NULL, center=FALSE, standard_form=TRUE) {
