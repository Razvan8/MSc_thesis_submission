...
fit=hierNet(X_only_main, y_all, lam=25, diagonal = FALSE, stand.main=FALSE,tol=1e-10)
#fit$th
...
theta_bound<-(fit$th +t(fit$th))*5 #bound library
lambda<-55
...
psi_init<-get_psi_from_psi_vec3(as.vector(coefs[range_psi]),l1=l1,l2=l2,l3=l3)*0 ##
